					...
					<div class="main_skill">
						<div class="col-md-6">
							<div class="skill_content wow fadeIn">
								...
								<ul>
                                <li style="list-style-type:square;align:justify;line-height:25px;color:black;">There should not be any vulgarity or obscenity in actions, costumes or wordings.</li>
							    <li style="list-style-type:square;align:justify;line-height:25px;color:black;">No registration fees.</li>
							
								<li style="list-style-type:square;align:justify;line-height:25px;color:black;">Judges decision will be final.</li>
								<!--<li style="list-style-type:square;align:justify;line-height:25px;color:black;">Competition duration will be
								    ...
								    ?>.</li>-->
								<li style="list-style-type:square;align:justify;line-height:25px;color:black;"> Reporting time for all the competitions is 10:00 am.</li>
								...
								<li style="list-style-type:square;align:justify;line-height:25px;color:black;">Every participant must carry their ID proof.</li>
				...
				<div class="row">
					<div class="skill_bottom_content text-center">
						...
						<div class="col-md-3">
							<div class="skill_bottom_item">
								<script>
                                 var countDownDate = new Date("Feb 20, 2020 10:00:00").getTime();
                                      var now = new Date().getTime();
                                      var distance = countDownDate - now;
                                      var days = Math.floor(distance / (1000 * 60 * 60 * 24));
                                      diffDays = days ;
							        document.write("<h2 class='statistic-counter'>"+diffDays+"</h2>");
							    </script>
								<div class="separator_small"></div>
