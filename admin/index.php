...
if(isset($_POST['login'])) 
{
    ...
    $query = "select * from supertable where username='$username' and password='$password' ";
      ...
      <div class="content-wrapper d-flex align-items-stretch auth auth-img-bg">
        <div class="row flex-grow">
          ...
          <div class="col-lg-6 login-half-bg d-flex flex-row">
            <p class="text-white font-weight-medium text-center flex-grow align-self-end">Copyright &copy; 2020 Techicon  All rights reserved.</p>
          </div>
        </div>
      </div>
