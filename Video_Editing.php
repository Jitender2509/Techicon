                     ...
                     <div class="card-header" role="tab" id="headingOne1">
                        <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                           aria-controls="collapseOne1"><img height="35px" align="right" src="images/arrow.png">
                             <h5 class="mb-0" ><img src="images/ve.jpg">&nbsp; VIDEO  EDITING</h5>
                        </a>
                     </div>
                     <!-- Card body -->
                     <div id="collapseOne1" class="collapse show"  aria-labelledby="headingOne1" data-parent="#accordionEx">
                        <div class="card-body" style="text-align:justify;">
                             Editing video is about movement, choreography, lighting, color, and psychology. In this online video editing course, you'll learn the art and craft of editing videos using Adobe Premier or equivalent program. Working with a pro digital artist, you'll explore how to apply time-honored principles of film editing using today's digital technology.....                        </div>
                     </div>
                  </div>
                  <!-- Accordion card -->
                  <!-- Accordion card -->
